...
public class ProductController {
    ...
    @PostMapping()
    public ResponseEntity<ProductResponseDto> createProudct(@RequestBody ProductDto productDto) {
    ...
    public ResponseEntity<ProductResponseDto> changeProductName(
        ...
        ProductResponseDto productResponseDto = productService.changetProductName(
